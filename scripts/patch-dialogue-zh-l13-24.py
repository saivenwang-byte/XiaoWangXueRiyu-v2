#!/usr/bin/env python3
"""将 curated_zh_l13_24 写入 dialogue-zh-l9-24.js"""
...
from curated_dialogue_zh_l13_24 import CURATED_L13_24, norm_jp
...
def main() -> int:
    ...
    n = 0
    for jp, zh in CURATED_L13_24.items():
        if mp.get(jp) != zh:
            mp[jp] = zh
            n += 1
    ...
    print(f"[OK] patch-dialogue-zh-l13-24: updated {n} keys, total {len(mp)}")
    return 0
